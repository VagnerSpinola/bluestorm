...
@toker_required
def get_all_vendas(current_user):
    '''
...
@toker_required
def create_clients(current_user):
    '''
...
@toker_required
def create_medicamentos(current_user):
    '''
...
@app.route('/usuarios/<public_id>', methods=['PUT'])
@toker_required
def update_user(current_user, public_id):
    '''
        Atualiza o usuario cadastrado no sistema com public_id fornecido pelo usuario 

        :type current_user: string
        :param current_user: Usuario logado no sistema

        :type public_id: integer
        :param public_id: ID publico do usuario a ser Atualizado no banco de dados
    '''
...
@app.route('/medicamentos/<id>', methods=['PUT'])
@toker_required
...
@app.route('/vendas/<id>', methods=['PUT'])
@toker_required
def update_vendas(current_user, id):
    '''
...
@app.route('/usuarios/<public_id>', methods=['DELETE'])
@toker_required
...
@app.route('/medicamentos/<id>', methods=['DELETE'])
@toker_required
def delete_medicamentos(current_user, id):
    '''
...
@app.route('/vendas/<id>', methods=['DELETE'])
@toker_required
def delete_vendas(current_user, id):
    '''
        eleta a venda cadastrado no sistema com id fornecido pelo usuario 
